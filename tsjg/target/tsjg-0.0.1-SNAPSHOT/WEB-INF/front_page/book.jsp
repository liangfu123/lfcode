	...
	<div class="left_big">
		<div class="left_list">
			<ul class="nav nav-pills nav-stacked">
			  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/toBooksubject.shtml" target="rightFrame">学科参考</a></li>
			  <li role="presentation"><a href="${pageContext.request.contextPath}/toBookcategory.shtml" target="rightFrame">图书分类</a></li>
			</ul>
		</div>
