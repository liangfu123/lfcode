			      ...
			      <div class="modal-body">
			        <table style="width: 700px;margin-left: 30px;">
			        	<tr height="40">
				        	...
				        	<td>
				        		<input style="width: 250px;" type="text" class="form-control" name="realname" value="${user.realname }">
				        	</td>
			        	</tr>
			        	<tr height="40">
			        	...
			        	<tr height="40">
				        	...
				        	<td>
				        		<input style="width: 250px;" type="text" class="form-control" name="phone" value="${user.phone }">
				        	</td>
			        	</tr>
			        	<tr height="40">
				        	<td style="text-align: right;">电子邮箱：</td>
				        	<td>
				        		<input style="width: 250px;" type="text" class="form-control" name="email" value="${user.email }">
				        	</td>
			        	</tr>
			        	<tr height="40">
				        	<td style="text-align: right;">QQ号：</td>
				        	<td>
				        		<input style="width: 250px;" type="text" class="form-control" name="qq" value="${user.qq }">
				        	</td>
			        	</tr>
			        	<tr height="40">
