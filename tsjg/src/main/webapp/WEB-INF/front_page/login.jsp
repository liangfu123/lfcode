...
<body>
	<div class="login_big" style="background-image:url(${pageContext.request.contextPath }/img/login.gif)">
		<div class="login_small">
			<br>
			<label style="font-size: 36px;margin-left: 70px;color: #F75000;"><span style="font-size: 26px;">阿坝师范学院</span> | 图书荐购系统</label>
