	...
	<div class="left_big">
		<div class="left_list">
			<ul class="nav nav-pills nav-stacked">
			  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/toRankbook.shtml" target="rightFrame">图书排行榜</a></li>
			  <li role="presentation"><a href="${pageContext.request.contextPath}/toRankmag.shtml" target="rightFrame">期刊排行榜</a></li>
			</ul>
		</div>
			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="height: 174px;width: 200px;">
			  ...
			  <div class="carousel-inner" role="listbox">
			    <div class="item active">
			      <img style="height: 174px;width: 200px;" src="${pageContext.request.contextPath}/img/lunbo1.jpeg">
			      <div class="carousel-caption"></div>
			    </div>
			    <div class="item">
			      <img style="height: 174px;width: 200px;" src="${pageContext.request.contextPath}/img/lunbo2.jpeg">
			       <div class="carousel-caption"></div>
			    </div>
			    <div class="item">
			      <img style="height: 174px;width: 200px;" src="${pageContext.request.contextPath}/img/lunbo3.jpeg">
			       <div class="carousel-caption"></div>
			    </div>
			  </div>
			</div>
