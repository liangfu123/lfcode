	...
	<div class="left_big">
		<div class="left_list">
			<ul class="nav nav-pills nav-stacked">
			  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/toMagCategory.shtml" target="rightFrame">期刊分类</a></li>
			  <li role="presentation"><a href="${pageContext.request.contextPath}/toMagsearch.shtml" target="rightFrame">期刊检索</a></li>
			</ul>
		</div>
